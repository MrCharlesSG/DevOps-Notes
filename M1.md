...
- [M1](#m1)
- [Lab 2](#lab-2)
      + [**1. Connect to the workstation VM inside RH Academy lab environment.**](#1-connect-to-the-workstation-vm-inside-rh-academy-lab-environment)
      + [**2. Find the latest nginx container image from Docker Hub.**](#2-find-the-latest-nginx-container-image-from-docker-hub)
      + [**3. Find the documentation explaining the use of that image.**](#3-find-the-documentation-explaining-the-use-of-that-image)
      + [**4. List running containers on the system.**](#4-list-running-containers-on-the-system)
      + [**5. Pull the image you found.**](#5-pull-the-image-you-found)
      + [**6. Find more information about the container image.**](#6-find-more-information-about-the-container-image)
      + [**7. Create a container instance in the background and map it to port 80.**](#7-create-a-container-instance-in-the-background-and-map-it-to-port-80)
      + [**8. Create an instance of the container and map it to port 8080.**](#8-create-an-instance-of-the-container-and-map-it-to-port-8080)
      + [**9. List running containers.**](#9-list-running-containers)
      + [**10. Stop the first container you created.**](#10-stop-the-first-container-you-created)
      + [**11. Try creating another container instance named web8080.**](#11-try-creating-another-container-instance-named-web8080)
      + [**12. Inspect the details of web8080 container.**](#12-inspect-the-details-of-web8080-container)
      + [**13. List all the images you have downloaded.**](#13-list-all-the-images-you-have-downloaded)
      + [**14. Export the nginx image.**](#14-export-the-nginx-image)
      + [**15. Command to create, modify, and save a new image.**](#15-command-to-create-modify-and-save-a-new-image)
      + [**16. Command to change the contents of the default web page of web8080 container without terminating it.**](#16-command-to-change-the-contents-of-the-default-web-page-of-web8080-container-without-terminating-it)
- [Lab 3](#lab-3)
...
<!-- TOC --><a name="1-connect-to-the-workstation-vm-inside-rh-academy-lab-environment"></a>
### **1. Connect to the workstation VM inside RH Academy lab environment.**

Assuming you're already connected to the workstation VM.

<!-- TOC --><a name="2-find-the-latest-nginx-container-image-from-docker-hub"></a>
...
<!-- TOC --><a name="3-find-the-documentation-explaining-the-use-of-that-image"></a>
...
<!-- TOC --><a name="4-list-running-containers-on-the-system"></a>
...
<!-- TOC --><a name="5-pull-the-image-you-found"></a>
...
<!-- TOC --><a name="6-find-more-information-about-the-container-image"></a>
...
<!-- TOC --><a name="7-create-a-container-instance-in-the-background-and-map-it-to-port-80"></a>
...
<!-- TOC --><a name="8-create-an-instance-of-the-container-and-map-it-to-port-8080"></a>
...
<!-- TOC --><a name="9-list-running-containers"></a>
...
<!-- TOC --><a name="10-stop-the-first-container-you-created"></a>
...
<!-- TOC --><a name="11-try-creating-another-container-instance-named-web8080"></a>
...
<!-- TOC --><a name="12-inspect-the-details-of-web8080-container"></a>
...
<!-- TOC --><a name="13-list-all-the-images-you-have-downloaded"></a>
...
<!-- TOC --><a name="14-export-the-nginx-image"></a>
...
<!-- TOC --><a name="15-command-to-create-modify-and-save-a-new-image"></a>
...
<!-- TOC --><a name="16-command-to-change-the-contents-of-the-default-web-page-of-web8080-container-without-terminating-it"></a>
